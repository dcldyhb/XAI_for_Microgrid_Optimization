...
# [MODIFIED] 使用 config 中的 OUTPUTS_ROOT，并移除重复代码
...
for i_episode in itertools.count(1):
    ...
    while not done:
        ...
        if gamma_calculator:
            # PySR 计算器需要一个 numpy 数组或 list 作为输入
            # state 已经是 numpy array
...
def plot_microgrid_power_from_info(infos, env, save_dir=None):
    ...
    try:
        ...
        # 子图2: 系统能量平衡
        total_load = load_p # [MODIFIED] 修复了 undefined variable
